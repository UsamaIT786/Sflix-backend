...
export default function RegisterView({ onBackToHome, onRegisterSuccess, onSwitchToLogin, onLoginSuccess }: RegisterViewProps) {
      ...
      >
        <div className="bg-neutral-900/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">Join Novaplay Stream</p>
          </div>
